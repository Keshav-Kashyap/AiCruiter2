...
import AlretConfirmation from './_components/AlretConfirmation';
    ...
    return (
        <div className='p-20 lg:px-48 xl:px-56'>
            ...
            <h2 className='font-bold text-xl flex justify-between'>AI Interview Sesstion
                ...
                <span className='flex items-center gap-2'><Timer />
                    00:00:00
                </span>
            </h2>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-7 mt-5'>
                <div className='bg-white h-[400px] rounded-lg border flex items-center flex-col gap-3 justify-center'>
                    <div className='relative'>
                        ...
                        <Image src={'/ai.png'} alt="" width={100} height={100} className='w-[60px] h-[60px] rounded-full    object-cover ' />
                    </div>

                    <h2>AI Recuiter</h2>
                </div>
                <div className='bg-white h-[400px] flex-col gap-3 rounded-lg border flex items-center justify-center'>
                    {/* <Image src={'/ai.png'} alt="" width={100} height={100} className='w-[60px] h-[60px] rounded-full    object-cover ' /> */}
                    <div className='relative'>
                        {activeUser && < span className='absolute inset-0 rounded-full bg-blue-500 opacity-75 animate-ping' />}
                        <h2 className='text-2xl bg-primary text-white p-3 rounded-full px-5'>{interviewInfo?.userName[0]?.toUpperCase()}  </h2>
                    </div>
